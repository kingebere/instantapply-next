...
console.log(resp)
  ...
  useEffect(()=>{
    axios.post('/api/getJobs', { url }).then((res)=> setResp(res.data))
  ...
  return (
    <>
      ...
      <div className="bg-gray-50 dark:bg-gray-800">
        <div className="flex overflow-hidden pt-6 bg-gray-50 dark:bg-gray-900">
          <div
                              ...
                              {resp && resp[0] && 
                                resp[0]?.map((job: any, i: number) => (
                                  ...
                                  <tr key={job.links}>
                                    ...
                                    <td 
                                    onClick={()=> setShowJob({title:job.title, timePosted:job.timePosted, detail:job.jobDetails, link: job.links})}
                    ...
                    <ul className="inline-flex items-stretch -space-x-px">
                      <li>
                        <button
                          ...
                          disabled={resp && resp[1][0]?.pageNumber!=="Previous"}
