  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Autofill job applications easily" />
        ...
        <section className="bg-instant-light-100 dark:bg-gray-900 ">
          <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 relative z-50">
            ...
            <h1 className="mb-4 text-4xl font-extrabold font-silka tracking-tight leading-tight text-instant-600 md:text-5xl lg:text-8xl px-5 dark:text-white">
              Autofill your Job{" "}
              <span className="text-instant-text">
            ...
            <p className="mb-8 text-lg  text-instant-textgrey font-silka font-medium  sm:px-16 xl:px-60 dark:text-gray-400">
              Submit job applications—10x faster. InstantApply autofills your
              work history on job boards as faster as lightening with just a
              single click{" "}
            </p>
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              <div
                onClick={signInWithGoogle}
                className="inline-flex cursor-pointer font-silka justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-instant-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
              >
                Sign in With Google
                <svg
              ...
              <a
                ...
                className="inline-flex justify-center font-silka items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
              >
                <svg
            ...
            <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
              <span className="font-semibold font-silka text-gray-400 uppercase">
                Trusted by the world&lsquo;s top companies
              </span>
